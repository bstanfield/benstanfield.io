...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var books = [{
    ...
    tags: "Time Travel",
    goodreads: "https://www.goodreads.com/book/show/58446227-sea-of-tranquility"
  }, {
    path: "artemis.png",
    emoji: "🌝",
    title: "Artemis",
    ...
    title: "Drunk",
    tags: "Anthropology",
    goodreads: "https://www.goodreads.com/book/show/55643282-drunk?from_search=true&from_srp=true&qid=HcsfTZl6AE&rank=1",
    date: "Jan. 2024"
  }, {
    ...
    tags: "History",
    goodreads: "https://www.goodreads.com/book/show/61102803-invention-and-innovation",
    date: "May 2023"
  }, {
    path: "liftoff.png",
    emoji: "🚀",
    ...
    tags: "Biography",
    goodreads: "https://www.goodreads.com/book/show/2199.Team_of_Rivals?ref=nav_sb_ss_1_14",
    date: "Jan. 2023"
  }, {
  ...
  $(document).ready(function () {
    ...
    $("#book-iterator-right").click(function () {
      document.getElementById("books").scrollBy({ left: 278, behavior: "smooth" });
    });
    ...
    $("#book-iterator-right").on("mousedown", function () {
      timeoutId = setInterval(function () {
        document.getElementById("books").scrollBy({ left: 1500, behavior: "smooth" });
      }, 750);
